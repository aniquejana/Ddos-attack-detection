...
binary_train_X, binary_val_X, binary_train_y, binary_val_y = train_test_split(to_fit, binary_y,random_state=0, test_size=0.6)
multi_train_X, multi_val_X, multi_train_y, multi_val_y = train_test_split(to_fit, multi_y,random_state=0, test_size = 0.6)
...
dataset = load_digits()
binary_train_X_1, binary_val_X_1, binary_train_y_1, binary_val_y_1 = train_test_split(dataset.data, dataset.target,random_state=4, test_size=0.30)
Classifier=SVC(kernel="linear")
Classifier.fit(binary_train_X_1,binary_train_y_1)
binary_predictions=Classifier.predict(binary_val_X_1)
accuracy=accuracy_score(binary_val_y_1,binary_predictions)*100
confusion_mat =confusion_matrix(binary_val_y_1,binary_predictions)
print("SVM() Accuracy Score :", accuracy)
print("confusion Matrix: ")
print(confusion_mat)
print("Classification report")
print(classification_report(binary_val_y_1,binary_predictions))
clf = SVC()
clf.fit(binary_train_X,binary_train_y)
RocCurveDisplay.from_estimator(clf,binary_val_X,binary_val_y)
plt.show()
